        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-bold mb-0"> Edit Pesanan</h4>
                    </div>
                </div>
            </div>
        </div>
        <form method="POST" action="{{ route('pesanan.update',['id' => $edit->id]) }}" enctype="multipart/form-data" class="forms-sample">
            @csrf
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="Quantity" placeholder="Quantity" name="qty" value="{{ $edit->qty }}" required>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="Date" placeholder="Date" name="date" value="{{ $edit->date }}" required>
                                </div>
